...
class APITestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_products = [
            {"id": "prod1", "title": "Fashion Dress", "price": "25.00", "weight": 0.5},
            {"id": "prod2", "title": "Designer Jeans", "price": "45.00", "weight": 0.8},
        ]
...
class FlaskAPIEndpointsTest(APITestCase):
    ...
    def test_api_parse_customer_invalid_input(self):
        ...
        response = self.client.post(
            "/api/parse_customer", json={"input": ""}, content_type="application/json"
        )
...
class ErrorHandlingTest(APITestCase):
    ...
    def test_invalid_json_requests(self):
        ...
        response = self.client.post(
            "/api/parse_customer", data="invalid json", content_type="application/json"
        )
