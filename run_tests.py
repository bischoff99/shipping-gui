...
class TestRunner:
    ...
    def run_integration_tests(self):
        ...
        print("⚠️  This will make real API calls - please ensure you're using test/staging keys!")
    ...
    def generate_test_report(self, unit_success, integration_success, integration_run):
        ...
        overall_success = unit_success and (integration_success if integration_run else True)
