...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'sqlite:///shipping_automation.db')
    ...
    INVENTORY_MONITORING_ENABLED = os.environ.get('INVENTORY_MONITORING_ENABLED', 'true').lower() == 'true'
    INVENTORY_CHECK_INTERVAL = int(os.environ.get('INVENTORY_CHECK_INTERVAL', 60))  # 1 minute
